...
#define STRING_CONFIG_H_AUTHOR "(Jens Pfeifle, Anet A8)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 100 } // 20-tooth pulleys on X,Y
...
#define Y_BED_SIZE 195 // glass plate is smaller
